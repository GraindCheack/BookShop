...
from app_book.models import Book, Author, Sale, SystemNotification, PersonalNotification, SystemNotificationRead
...
class SystemNotificationReadSerializer(serializers.ModelSerializer):
    class Meta:
...
class PersonalNotificationSerilizer(serializers.ModelSerializer):
    class Meta:
        model = PersonalNotification
        fields = ('id', 'message', 'date', 'is_read')
